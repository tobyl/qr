    ...
    <div className="CoverageList">
      ...
      >
        <p className="BriefDescription">
          ...
          damages to your vehicle not caused by a traffic accident (e.g. theft,
          fire, vandalism).
        </p>
        <div className="Modify">
          <RadioGroup
          ...
          <div className="HelpCopy">
            <small>
              Comprehensive coverage is the maximum amount you pay in the event
      ...
      >
        <p className="BriefDescription">
          ...
          vehicle in the event of an at-fault accident, single vehicle accident,
          or hit and run.
        </p>
        <div className="Modify">
          <RadioGroup
      ...
      >
        <p className="BriefDescription">
          {values['transportation_replacement']} for a replacement vehicle if an
          insurance claim requires your vehicle to be out of service.
        </p>
        <div className="Modify">
          <RadioGroup
            name="transportation_replacement"
      ...
      >
        <p className="BriefDescription">
          {values['non_owned_autos']} on any rental vehicle in the Canada or US.
        </p>
        <div className="Modify">
          <RadioGroup
            name="non_owned_autos"
      ...
      <AccidentWaiverItem title="Accident Waiver" name="accident_waiver">
        <p className="BriefDescription">
          In the event of you being in an accident in which you are at fault, it
          will protect your driving record and forgive the accident.
        </p>
      </AccidentWaiverItem>
    </div>
  )
